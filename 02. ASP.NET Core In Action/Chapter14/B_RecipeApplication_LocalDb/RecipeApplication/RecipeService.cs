namespace RecipeApplication
{
    ...
    public class RecipeService
    {
        ...
        public RecipeService(AppDbContext context, ILoggerFactory factory)
        {
            ...
            this._logger = factory.CreateLogger<RecipeService>();
        }
        ...
        {
            var recipe = await this._context.Recipes.FindAsync(cmd.Id);
        ...
        {
            var recipe = await this._context.Recipes.FindAsync(recipeId);
